...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		 desktop: "https://www.stackmeow.tech/random?dir=imgforrandom&type=img",
/* 		desktop: [
			"assets/images/DesktopWallpaper/d1.avif",
			"assets/images/DesktopWallpaper/d2.avif",
		...
		// 移动背景图片（支持单张或多张随机）
		mobile: "https://www.stackmeow.tech/random?dir=imgforrandom&type=img",
/* 		mobile: [
			"assets/images/MobileWallpaper/m1.avif",
			"assets/images/MobileWallpaper/m2.avif",
		...
		playerUrl: [
			"https://www.image2url.com/r2/default/videos/1785688643545-1aa12202-fc8b-433f-ad3e-6208dea3fcdf.mp4",
		],
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			subtitle: [
				"足够多的眼睛，就可让所有问题浮现。",
				"当我们谈论开源软件时，我们指的是开源，而不是价格。",
				"专有软件是不正义的。分享是美好的，而在数字技术时代，分享是轻而易举的",
				"没有一个公司能强大到可以独自雇佣所有人。",
				"开源是历史上最伟大的智力共享项目。",
				"自由不仅仅是能够选择你的领导者，它还在于成为你自己的领导者。",
				"在开源中，我们不需要相互信任，因为代码本身就是诚实的。",
				"现代世界运行在开源之上。",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
